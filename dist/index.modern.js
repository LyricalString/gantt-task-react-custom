...
var TaskListHeaderDefault = function TaskListHeaderDefault(_ref) {
  ...
  }, "\xA0ID Proyecto"), React.createElement("div", {
  ...
  }, "\xA0Tarea"), React.createElement("div", {
    className: styles.ganttTable_HeaderSeparator,
    style: {
      height: headerHeight * 0.5,
  ...
  }, "\xA0Responsable"), React.createElement("div", {
    className: styles.ganttTable_HeaderSeparator,
    style: {
      height: headerHeight * 0.5,
      marginTop: headerHeight * 0.25
...
var TaskListTableDefault = function TaskListTableDefault(_ref) {
  ...
  return React.createElement("div", {
    ...
    return React.createElement("div", {
      ...
      className: styles$1.taskListCell + " projectID",
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth
      },
    ...
    }, expanderSymbol), React.createElement("div", null, t.project))), React.createElement("div", {
      className: styles$1.taskListCell + " taskType",
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth
      }
    }, "\xA0", t.taskType), React.createElement("div", {
      className: styles$1.taskListCell + " taskResponsable",
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth
      }
    }, "\xA0", t.taskResponsable));
  }));
};
...
var StandardTooltipContent = function StandardTooltipContent(_ref2) {
  ...
  }, "Duración: " + ~~((task.end.getTime() - task.start.getTime()) / (1000 * 60 * 60 * 24)) + " day(s)"), React.createElement("p", {
    className: styles$2.tooltipDefaultContainerParagraph
